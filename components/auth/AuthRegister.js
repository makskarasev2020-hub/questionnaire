...
const AuthRegister = ({
    ...
    const validationSchema = yup.object().shape({
        ...
        password: yup.string().label('Password').required().min(4).max(20),
        re_password: yup.string().label('Password').required().min(4).max(20),
    });
                    ...
                    <View>
                        ...
                        <View style={{ marginBottom: 10 }}>
                            <AppInput
                                ...
                                isValid={
                                    !formikProps.errors.re_password ||
                                    !formikProps.touched.re_password
                                }
                                secureTextEntry
                                style={{ color: '#000000' }}
                            />
